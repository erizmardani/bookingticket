...
import 'package:ticketbooking/controllers/profile_controller.dart';
...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    String? name = AuthController.instance.user!.displayName ?? "Enter your name";
    String? email = AuthController.instance.user!.email;
    String? mobile = AuthController.instance.user!.phoneNumber ?? "08............";
